    ...
    <body id="profile">
        ...
        <div class="container">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <?php for($i = 0; $i < $num_friends; $i++): ?>
                                ...
                                <a  class="friends__name"><?php echo $row['first_name']. ' ' . $row['last_name']; ?></a>
                            </div>
            ...
            <?php
                ...
                $sql = "SELECT * FROM friends WHERE (user_id_one={$user_id_one} AND user_id_two={$user_id_two})
                        OR (user_id_one={$user_id_two} AND user_id_two={$user_id_one})";
                    ...
                    <div class="text-wall-post white-background">
                        ...
                        <div class="text-wall-post__content">
                            ...
                            <form action="process/like-create.php" method="POST" class="text-wall-post__actions">
                                ...
                                <button><i class="fa fa-thumbs-up" aria-hidden="true"></i><h3><?php echo $likes_num; ?></h3></button>
